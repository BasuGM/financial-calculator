...
// Interface defining the structure for yearly withdrawal tracking data
...
/**
 * ResultsCard component displays SWP calculation results including total withdrawals,
 * remaining balance, and depletion alerts. Provides access to detailed breakdowns via dialogs.
 */
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <TableDialog
            ...
            description="Detailed annual progression of your SWP withdrawals"
          ...
          <ChartDialog
            ...
            description="Visual representation of your portfolio depletion and withdrawals"
            data={chartData}
            lines={chartLines}
            xAxisKey="year"
            xAxisLabel="Years"
