...
// Interface defining the structure for yearly investment tracking data with step-up increments
...
/**
 * ResultsCard component displays Step Up SIP calculation results including total investment,
 * estimated returns, future value, and provides access to detailed breakdowns via dialogs.
 * Handles display logic for percentage vs multiplier format based on return ratio.
 */
export function ResultsCard({ totalInvestment, estimatedReturns, futureValue, yearlyBreakdown }: ResultsCardProps) {
  ...
  // Prepare chart data starting from year 0 to show investment growth trajectory with step-up
  const chartData = [
