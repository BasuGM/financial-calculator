...
/**
 * Represents the breakdown of EMI loan repayment for a single year
 */
 ...
 * Displays the calculated results of the EMI loan including monthly EMI amount,
 * total interest, total payment, and visualizations through progress bar, table, and chart
 */
export function ResultsCard({ loanAmount, totalInterest, totalPayment, emi, yearlyBreakdown }: ResultsCardProps) {
